...
//some flags to be dfined so we can set each page tables settings
enum PAGE_PTE_FLAGS {
...
//a way to represent an entry
//! page table entry
typedef uint32_t pt_entry;


//these flags will be used in the page directory. because they are quite the same the flags will be identical
enum PAGE_PDE_FLAGS {
...
//some functions to edit/modify page tables
//functions for the page entry tabel
